---
---
export const { flavor = "generic" } = frontmatter;
...
## {flavor === "creative" && <span class="icon">🧠</span>} Summary
...
## {flavor === "creative" && <span class="icon">🛠️</span>} Technical Expertise
...
## {flavor === "creative" && <span class="icon">🧭</span>} Leadership & Project Skills
...
## {flavor === "creative" && <span class="icon">💼</span>} Professional Experience
...
## {flavor === "creative" && <span class="icon">🎓</span>} Education
...
## {flavor === "creative" && <span class="icon">📜</span>} Certifications
...
## {flavor === "creative" && <span class="icon">🌍</span>} Languages
...
## {flavor === "creative" && <span class="icon">🙌</span>} Volunteer Experience
...
## {flavor === "creative" && <span class="icon">🏅</span>} Competitions & Awards
...
## {flavor === "creative" && <span class="icon">💬</span>} What Others Say
